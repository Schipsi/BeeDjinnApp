...
public class Hugoj extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hugoj);

        Button toMenu = (Button) findViewById(R.id.toMenu);
        toMenu.setOnClickListener(this);

        ImageButton toAmandine = (ImageButton) findViewById(R.id.toAmandine);
        toAmandine.setOnClickListener(this);

        ImageButton toHugor = (ImageButton) findViewById(R.id.toHugor);
        toHugor.setOnClickListener(this);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.hugoj);
        layout.setOnTouchListener(new OnSwipeTouchListener(layout.getContext()){
            public void onSwipeRight (){
                finish();
                Intent toAmandine = new Intent(layout.getContext(),Amandine.class);
                startActivity(toAmandine);
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);

            }
            public void onSwipeLeft(){
                finish();
                Intent toHugor = new Intent(layout.getContext(),Hugor.class);
                startActivity(toHugor);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.toAmandine:
                finish();
                Intent toAmandine = new Intent(this,Amandine.class);
                startActivity(toAmandine);
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                break;
            ...
            case R.id.toHugor:
                finish();
                Intent toHugor = new Intent(this,Hugor.class);
                startActivity(toHugor);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                break;
