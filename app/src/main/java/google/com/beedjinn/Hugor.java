...
public class Hugor extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hugor);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.hugor);
