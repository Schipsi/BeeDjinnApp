...
public class Victort extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.victort);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.victort);
