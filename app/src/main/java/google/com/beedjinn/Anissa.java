...
public class Anissa extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.anissa);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.anissa);
