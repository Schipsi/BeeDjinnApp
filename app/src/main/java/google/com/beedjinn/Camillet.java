...
public class Camillet extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.camillet);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.camillet);
