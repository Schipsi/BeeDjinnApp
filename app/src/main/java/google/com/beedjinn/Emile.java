...
public class Emile extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.emile);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.emile);
