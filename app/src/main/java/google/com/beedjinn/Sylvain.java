...
public class Sylvain extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sylvain);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.sylvain);
