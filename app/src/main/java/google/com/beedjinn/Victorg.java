...
public class Victorg extends Activity implements OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.victorg);

        Button toMenu = (Button) findViewById(R.id.toMenu);
        toMenu.setOnClickListener(this);

        ImageButton toAlice = (ImageButton) findViewById(R.id.toAlice);
        toAlice.setOnClickListener(this);
        ...
        final RelativeLayout layout=(RelativeLayout) findViewById(R.id.victorg);
        layout.setOnTouchListener(new OnSwipeTouchListener(layout.getContext()){
            public void onSwipeRight (){
                finish();
                Intent toAlice = new Intent(layout.getContext(),Alice.class);
                startActivity(toAlice);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.toAlice:
                finish();
                Intent toAlice = new Intent(this,Alice.class);
                startActivity(toAlice);
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                break;
